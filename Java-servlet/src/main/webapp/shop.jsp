...
<%
    ...
    Set<Product> productSet = ProductDB.getAllProductsbyset();
    request.setAttribute("products", products);
    request.setAttribute("product",productSet);
%>
<!-- products -->
                ...
                <div class="product-filters">
                    <ul>
                        ...
                        <c:forEach var="product" items="${product}">
                            <c:set var="className" value="${fn:replace(product, ' ', '-')}" />
                            <li data-filter=".${className}">${product}</li>
                        </c:forEach>
                    </ul>
                </div>
            </div>
